...
export function GlobalArcExplorer() {
  const globeConfig = {
    pointSize: 4,
    globeColor: "#062056",
    showAtmosphere: true,
  ...
  return (
    <div className="flex h-[550px] w-full flex-col-reverse items-center justify-start px-8 md:h-[800px] md:flex-row md:px-16 lg:px-32">
