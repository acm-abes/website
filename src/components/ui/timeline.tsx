    ...
    <div className="w-full font-sans md:px-10" ref={containerRef}>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-10 md:gap-4 md:pt-40"
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              ...
              <h3 className="hidden text-xl font-bold text-neutral-500 md:block md:pl-16 md:text-6xl dark:text-neutral-200">
                {item.title}
              </h3>
            </div>

            <div className="relative w-full pr-4 pl-16 md:pl-0">
