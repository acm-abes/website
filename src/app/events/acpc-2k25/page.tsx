      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl text-center">
          ...
          <p className="hero-subtitle mb-4 text-xl font-light text-gray-300 md:text-3xl">
            ABES Championship of Competitive Programming
          </p>

          <p className="hero-subtitle mx-auto mb-12 max-w-3xl text-lg text-emerald-400/80 md:text-xl">
            Where algorithms meet adrenaline. 6 problems. 3 hours. Infinite
            possibilities.
          </p>
          ...
          >
            {[
              ...
              { icon: Code2, label: "Problems", value: "6 Challenges" },
              { icon: IndianRupee, label: "Prize Pool", value: "15,000" },
              { icon: Trophy, label: "Format", value: "ICPC Style" },
            ].map((stat, i) => (
              <motion.div
                key={i}
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="mx-auto max-w-3xl text-xl leading-relaxed text-gray-300">
            Experience the thrill of high-stakes competitive programming at ACPC
            2K25, the flagship contest of ABES Engineering College. Inspired by
            the prestigious ICPC format, this is where the brightest minds
            collide.
          </p>
        </motion.div>
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          <p className="text-lg text-gray-300">
            🎉 Plus refreshments for all participants throughout the event!
          </p>
        </motion.div>
      </div>
    </section>
...
const GuidelinesSection = () => {
  ...
  const guidelines = [
    ...
    "AI/ML/LLM models are strictly prohibited",
    "6 problem statements to solve in 3 hours",
    "Report to venue on time with College ID (mandatory)",
    "This is an offline contest at designated location",
    ...
    <section ref={ref} className="px-4 py-20">
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="text-xl text-gray-300">Secure your spot now!</p>
        </motion.div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative rounded-2xl border-2 border-gray-500/30 bg-gray-900 p-8">
              ...
              <div className="mb-6">
                <span className="text-5xl font-black text-gray-300">₹70</span>
                <span className="ml-2 text-gray-400">/ team</span>
              </div>
  ...
  return (
    <section ref={ref} className="relative overflow-hidden px-4 py-32">
      ...
      >
        ...
        >
          Organized by ABES ACM Student Chapter & ABES ACM-W Chapter
        </motion.p>
      </motion.div>
    </section>
  );
